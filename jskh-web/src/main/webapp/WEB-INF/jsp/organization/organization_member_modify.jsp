...
<script src="${path}/static/js/organization/organization_member_modify.js"></script>
<style type="text/css">
.all {
				margin-left:40%;
				margin-right:40%;
...
<body class="all">
		<form class="layui-form layui-form-pane" action="">
		  <div class="layui-form-item">
			    <label for="job">职务&emsp;&emsp;</label>
			...
			<div style="margin-right: -5%;">
				<div class="layui-form-item">
					<div class="layui-input-block">
						<button class="layui-btn" lay-submit lay-filter="submit">增加</button>
