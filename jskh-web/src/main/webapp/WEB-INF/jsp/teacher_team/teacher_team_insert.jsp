			...
			<div class="layui-form-item" style="margin-left:10%;margin-top:2%">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="radio" name="latest" id="latest"  value="是" title="是" class="layui-input" checked="checked">
						<input type="radio" name="latest" id="latest"  value="否" title="否" class="layui-input" >					
					</div>
				</div>
			</div>
