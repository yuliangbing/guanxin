		  ...
		  <div class="layui-form-item" style="margin-top:5%;" >
				...
				<label class="layui-form-label" style="width:150px;">职务</label>
					<div class="layui-input-inline">
						<input type="text" name="name" disabled id="position" lay-verify="required"  autocomplete="off" class="layui-input">
					</div>
				</div>
				<div>
				<div class="layui-inline">
				<label class="layui-form-label" style="width:150px;">成员姓名</label>
					<div class="layui-input-inline">
