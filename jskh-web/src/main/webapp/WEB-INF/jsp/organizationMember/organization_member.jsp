...
<body class="layui-layout-body">
    ...
    <div class="layui-col-md12 layui-content-white">
      <div class="layui-row">
        ...
        <input type="text" name="position" id="position" placeholder="请输入职务" autocomplete="off" class="layui-input" style="width: 12%;">
          <input type="text" name="name" id="name" placeholder="请输入成员姓名" autocomplete="off" class="layui-input" style="width: 12%;">
