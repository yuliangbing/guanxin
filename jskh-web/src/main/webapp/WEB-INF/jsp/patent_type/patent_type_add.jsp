...
<script src="${path}/static/js/patent_type/patent_type_add.js"></script>
</head>
<body style="margin-left: 25%;">
		<form class="layui-form" action="">
		  <div class="layui-form-item" style="margin-top:5%;">
		  <div class="layui-inline">
			    <label for="job"class="layui-form-label" style="width:150px;">类型编号</label>
				...
				<div>
			 <div class="layui-inline">
			    <label for="job"class="layui-form-label" style="width:150px;">类型名称</label>
				<div class="layui-input-inline">
