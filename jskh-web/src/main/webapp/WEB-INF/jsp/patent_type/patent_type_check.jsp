...
<script src="${path}/static/js/patent_type/patent_type_check.js"></script>
		  ...
		  <div class="layui-form-item" style="margin-top:5%;" >
				...
				<label class="layui-form-label" style="width:150px;">类型编号</label>
					<div class="layui-input-inline">
						<input type="text" name="code" disabled id="code" lay-verify="required"  autocomplete="off" class="layui-input">
					</div>
				</div>
				<div>
				<div class="layui-inline">
