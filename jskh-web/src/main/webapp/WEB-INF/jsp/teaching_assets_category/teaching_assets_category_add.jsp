...
<script type="text/javascript" src="./js/xadmin.js"></script>
	<script type="text/javascript" src="${path}/static/js/teaching_assets_category/teaching_assets_category_add.js"></script>
</head>
<body>
       ...
       <div class=" layui-form-item">
        <lable>创建时间</lable> 
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="username" id="data" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
				</div>
			</div>
