...
<script type="text/javascript"
	src="${path}/static/js/foreign_exchange/foreign_exchangeList.js"></script>
</head>
<body class="layui-layout-body">
	...
	<div class="layui-col-md12 layui-content-white">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so" onsubmit="return false;">
				<input class="layui-input" placeholder="时间" name="date" id="date"
					autocomplete="off" style="width: 200px;"> <input
					type="text" name="units" id="units" placeholder="请输入单位"
					autocomplete="off" class="layui-input"> <input type="text"
					name="participants" id="participants" placeholder="请输入参与人员"
	...
	<script type="text/html" id="toolbarDemo">
		<div style="margin:-5px -1px;">
			<button class="layui-btn layui-btn-danger" lay-event="delData"><i 

class="layui-icon"></i>批量删除</button>
			<button class="layui-btn" lay-submit lay-filter="insertAdd" id="insert"><i 
