   ...
   <!--  <div class="layui-col-md12 layui-content-white">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          ...
          <input type="text" name="name" id="name" placeholder="请输入成果名称" autocomplete="off" class="layui-input">
       ...
       <table class="layui-hide" style:"margin-top:50px;" id="test" lay-filter="test"></table>
    </div>
