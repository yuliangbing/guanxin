    ...
    <div class="layui-col-md12 layui-content-white">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          <input class="layui-input" placeholder="时间" name="setupDate" id="setupDate" autocomplete="off" style="width:200px;">
         <!--   <input type="text" name="units" id="units" placeholder="请输入合作单位" autocomplete="off" class="layui-input"> -->
