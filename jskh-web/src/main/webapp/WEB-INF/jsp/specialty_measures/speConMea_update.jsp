		...
		<form class="layui-form" onsubmit="return false;">
			...
			<div class="layui-form-item" style="margin-left:18%;margin-top:2%">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input name="measures" id="measures" lay-verify="required" autocomplete="off" class="layui-input" type="text">
					</div>
				</div>
	...
	*/
	...
	/*提交功能*/
	  form.on('submit(submit)', function(data) {
			...
			params.measures = $("#measures").val();
			params.specialtyId = $("#specialtyId option:checked").val();
			params.specialty_name = $("#specialtyId option:checked").text();
			console.log(params);
			layer.confirm('确定提交吗?', {icon: 3, title:'提示'}, function(index){
			    $.ajax({
				        type:"POST",
				        url:window.path+'/specialtyConstructionMeasures/updateSpecialtyConstructionMeasuresIf?id='+id,
						data:$.param(params),
				        //预期服务器返回数据的类型
				        dataType:"json", 
				        success:function(data){
