...
var url = "";
    ...
    /*				  data = [{
              		    ...
              		    ,children: [{
              		      ...
              		      ,id: 1000
              		      ,children: [{
              		        label: '专业定位：'+obj2.data[0].position
              		        ,id: 10001
              		      },{
              		        label: '专业特色：'+obj2.data[0].characteristic 
              		        ,id: 10002
              		      }]
              		    }]
              	  }]*/
    				 ...
    				 var h ="";
   				  h+='[{label: 专业名称：'+name+',id: '+1
   				  +',children: [{label: 专业设立时间：'+date+',id: '+1000+',children: [{label: 专业定位：'+obj2.data[0].position+',id: '+10001+'},{label: 专业特色：'+obj2.data[0].characteristic+',id:'+10002+'}]}] }]';
